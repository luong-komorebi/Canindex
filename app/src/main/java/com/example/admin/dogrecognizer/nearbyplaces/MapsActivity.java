package com.example.admin.dogrecognizer.nearbyplaces;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Button btnZoo = (Button) findViewById(R.id.btnZoo);
        btnZoo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MapsActivity.this,"Nearby Zoos", Toast.LENGTH_LONG).show();
            }
        });
