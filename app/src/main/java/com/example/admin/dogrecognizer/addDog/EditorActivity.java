 ...
 */
package com.example.admin.dogrecognizer.addDog;
...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    /** Content URI fo the existing pet (null if it's a new pet) */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // If the intent DOES NOT contain a pet contain URI, then we know we are
        // creating a pet.
    ...
    private void savePet() {
        ...
        if(mCurrentPetUri == null){
            ...
            // Otherwise this is an EXISTING pet, so update pet with content URI: mCurrentPetUr
            // and pass in the new ContentValues. Pass in null for the selection and selection args
            // because mCurrentPetUri will already indentify the correct row in database that
            // we want to modify
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        // If the {@link mCurrentPetUri} is null (New Pet) then return null
        if(mCurrentPetUri == null) {
            return null;
        }
    ...
    private void showUnsavedChangesDialog(
        ...
        builder.setNegativeButton(R.string.keep_editing, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                // User clicked the "K eep editing" button, so dismiss the dialog
